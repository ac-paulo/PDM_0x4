...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var btCRIADOR: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.btCRIADOR = findViewById(R.id.btCRIADOR)
        ...
        this.btCRIADOR.setOnClickListener{
            val launchIntent = packageManager.getLaunchIntentForPackage("com.example.pdm_0x3")
